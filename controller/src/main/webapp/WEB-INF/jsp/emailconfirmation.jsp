                ...
                <div class="panel-body">
                    <c:choose>
                        <c:when test="${message eq 'emailconfirmationsuccessful'}">
                            <div class="alert alert-success" role="alert"><spring:message
                                    code="emailconfirmationsuccessful"/></div>
                        </c:when>
                        <c:when test="${message eq 'confirmationerror'}">
                            <div class="alert alert-danger" role="alert"><spring:message
                                    code="emailconfirmationerror"/></div>
                        </c:when>
                    ...
                    <a class="btn btn-primary col-sm-6 col-sm-offset-3 btn-lg" role="button" href="/home"><span
