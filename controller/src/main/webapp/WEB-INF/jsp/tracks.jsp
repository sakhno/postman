...
<head>
    ...
    <script type="text/javascript" language="javascript"
            src="com.postman.gwt.Postmangwt/com.postman.gwt.Postmangwt.nocache.js"></script>
...
<div class="container">
    <div class="row">
        <div class="col-sm-5">
            <div class="panel panel-default" id="activetrackspanel">
                <div class="panel-heading clearfix">
                    <div class="col-sm-6">
                        <h4 class="panel-title"><spring:message code="activetracks"/></h4>
                    </div>
                    <a class="btn btn-success col-sm-4 pull-right" href="#" id="newtrackbutton"><spring:message
                            code="addnewtrack"/></a>
                </div>
                <%--<table class="table table-striped table-hover" style="cursor: pointer" id="activetrackstable">--%>
                <%--<tr href="#">--%>
        ...
        <div class="col-sm-7">
            <div class="panel panel-default">
                ...
                <div class="panel-body" id="trackinfobody">
                    fgkjhdskjfsjk
                </div>
            </div>
        </div>
